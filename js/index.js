...
const FinalFunctionEjecution = () => {
    ...
    framesParticle(Palomita2, 27, 75, 9, 11.625, 45); 
    framesParticle(Palomita3, 20, 75, 9, 13.25, 45); //
    framesParticle(Palomita4, 29, 75, 9, 14.875, 45); // un poco mas fuerte, menos de 30
    ...
    framesParticle(Palomita8, 38, 75, 9, 21.375, 45);  // un poco mas fuerte
}
